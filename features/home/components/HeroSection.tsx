 ...
 * Features: headline, tagline, Pincode Checker Bar, dual CTA buttons, floating decorative elements.
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
          ...
          >
            ...
            <h1 className="font-heading text-4xl font-bold leading-[1.1] tracking-tight text-on-surface sm:text-5xl lg:text-6xl">
              Turn your scrap
              <br />
              into <span className="bg-gradient-to-r from-primary to-primary-container bg-clip-text text-transparent">instant cash</span>
            </h1>
            ...
            <p className="mt-6 max-w-lg text-lg leading-relaxed text-on-surface-variant">
              ...
              e-waste and appliances — at the <strong className="text-on-surface">best market rates</strong> with certified digital scales.
            </p>

            {/* Pincode Availability Lookup Bar */}
            <div className="mt-8">
              <PincodeCheckerBar />
            </div>

            {/* Micro value props */}
            <div className="mt-6 flex flex-wrap items-center gap-4 text-xs font-semibold text-on-surface-variant sm:gap-6">
          ...
          >
            <div className="relative">
              {/* Main card */}
              <div className="rounded-3xl border border-outline-variant/20 bg-surface-container-lowest p-8 shadow-2xl">
                <div className="mb-6 text-center">
                  <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-primary-container shadow-md shadow-primary/20">
                ...
                <div className="mt-6 pt-4 border-t border-outline-variant/15 text-center">
                  <Link
                    href={ROUTES.RATES}
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-primary hover:underline"
                  >
                    <span>View all 40+ scrap item rates</span>
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -left-4 rounded-2xl border border-outline-variant/20 bg-surface-container-lowest px-5 py-3.5 shadow-xl"
              >
                <div className="flex items-center gap-3">
                  <span className="text-3xl">♻️</span>
                  <div>
                    <p className="text-xs text-on-surface-variant">Diverted from Landfills</p>
                    <p className="text-base font-extrabold text-primary">500+ Tonnes</p>
                  </div>
                </div>
              </motion.div>
            </div>
